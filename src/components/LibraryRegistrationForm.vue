...
const validateReason = (blur) => {
  if (formData.value.reason.length < 6) {
    if (blur) errors.value.reason = 'Reason must be at least 6 characters.'
  } else {
...
const validateReasonContainWord = (blur) => {
  if (formData.value.reason.includes('friend')) {
    if (blur)  reasonContainFriend.value = true;
  } else {
    reasonContainFriend.value = false;
  }
}

const reasonContainFriend = ref(false)
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="reasonContainFriend" style="color:green;">Great to have a friend</div>
          </div>
          <div class="mb-3">
